...
/**
 * Loads entities for a {@code EntityPersister}
 *
 * @author Gavin King
...
public interface UniqueEntityLoader {
	/**
	 * Load an entity instance. If {@code optionalObject} is supplied,
	...
	/**
	 * Load an entity instance by id.  If {@code optionalObject} is supplied (non-{@code null},
